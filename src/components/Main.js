...
// let content=[["http://3.bp.blogspot.com/_DBYF1AdFaHw/TE-f0cDQ24I/AAAAAAAACZg/l-FdTZ6M7z8/s1600/Unicorn_and_Narwhal_by_dinglehopper.jpg","UniWhal", "A unicorn and a narwhal nuzzling their horns"],];
        ...
        return (
            <div>
                {/* for (let items of content) {
                    <HornedBeasts imageUrl={items[0][0]} title="" description="" />
                } */}
                {/* for (var i = 0; i < contentLength; i++) {
                     <HornedBeasts imageUrl="" title="" description="" />
